...
export const AddDogForm = ({ onCreated }) => {
	 ...
	 * Show a notification.
	 *
	 * These notifications remain exactly
	 * as they were before.
	 */
	...
	const onSubmit = async (e) => {
		...
		try {
			...
			/*
			 * ==================================================
			 * HOME SUCCESS NOTIFICATION
			 * ==================================================
			 *
			 * Store a one-time message for Home.
			 *
			 * This happens ONLY after addPost()
			 * succeeds.
			 *
			 * It does not change the post logic.
			 */
			...
			<Card className="p-6 md:p-8 shadow-card border-2 border-border/60 max-w-2xl mx-auto">
				...
				>
					...
					<div className="space-y-2">
						...
						<label
							htmlFor="photo"
							className="flex flex-col items-center justify-center w-full min-h-45 rounded-2xl border-2 border-dashed border-border bg-muted/40 hover:bg-muted cursor-pointer transition-smooth overflow-hidden"
						>
							{preview ? (
								<img
									src={preview}
