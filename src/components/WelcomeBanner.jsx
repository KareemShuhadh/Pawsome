...
export const WelcomeBanner = () => (
  <header className="relative overflow-hidden bg-gradient-hero">
    <div className="container mx-auto px-4 pt-12 pb-8 md:pt-20 md:pb-12 text-center">
      <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-card/80 backdrop-blur shadow-soft text-sm font-semibold text-primary mb-6">
        🐾 No login. Just dogs.
      </div>
