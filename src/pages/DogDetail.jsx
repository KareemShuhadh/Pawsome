...
const dummyPosts = [
  {
    ...
    owner_name: "Kaja",
    location: "Poland",
    description: "Best doggy ever! Loves belly rubs and stealing socks. Always ready for adventure and treats.",
  ...
  },
  {
    ...
    description: "A cheeky golden who steals socks for fun. Bella loves belly rubs, long walks in the park, and chasing butterflies.",
    image_url: "https://hips.hearstapps.com/aada87eb7c5759b5c9610ce497ee2445153497a6.jpg",
    votes: 42,
  },
];
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-6">This dog ran away! 🐕</p>
          <button 
            onClick={() => navigate("/")}
  ...
  return (
    <div className="min-h-screen bg-background pb-16">
      <div className="container mx-auto px-4 pt-6">
        ...
        <div className="max-w-2xl mx-auto bg-card rounded-2xl p-6 md:p-8 shadow-soft border border-border">
          <div className="flex items-start justify-between gap-4 mb-4">
            <h1 className="text-3xl md:text-4xl font-bold">{post.dog_name}</h1>
          ...
          <div className="flex flex-wrap gap-4 text-muted-foreground font-semibold mb-6">
            <span>👤 with {post.owner_name}</span>
